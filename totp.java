// source: https://tools.ietf.org/html/rfc6238#appendix-A
...
public class TOTP {
    ...
    public static void main(String[] args) {
		...
		String seed = "6E696E6A61406578616D706C652E636F6D4844454348414C4C454E4745303033";
        long T0 = 0;
        long X = 30;
        ...
        /* try{
            ...
            for(int i=0; i<testTime.length; i++) {
                ...
                System.out.println(generateTOTP(seed, steps, "8", "HmacSHA1") + "| SHA1   |");
              	...
              	System.out.print("|  " + fmtTime + "  |  " + utcTime + "  | " + steps + " |");
                System.out.println(generateTOTP(seed, steps, "8", "HmacSHA256") + "| SHA256 |");
                
              	System.out.print("|  " + fmtTime + "  |  " + utcTime + "  | " + steps + " |");
                System.out.println(generateTOTP(seed, steps, "8", "HmacSHA512") + "| SHA512 |");
		  ...
		  calendar.clear();
		  calendar.set(2014, Calendar.MARCH, 17, 15, 20, 51);
          long secondsSinceEpoch = calendar.getTimeInMillis() / 1000L;
          
          long T = (secondsSinceEpoch - T0)/X;
          steps = Long.toHexString(T).toUpperCase();
          while(steps.length() < 16) steps = "0" + steps;
          
          System.out.println("Seconds Since Epoch: " + secondsSinceEpoch);
          System.out.println("-----------------------------------------");
          System.out.println(generateTOTP(seed, steps, "10", "HmacSHA512"));
      	} catch (final Exception e){
            System.out.println("Error : " + e);
        }
    }
